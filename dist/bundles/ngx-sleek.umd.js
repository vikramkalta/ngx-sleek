(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/collections'), require('@angular/common'), require('@angular/cdk/table'), require('@angular/cdk/overlay'), require('@angular/cdk/portal')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@angular/cdk/collections', '@angular/common', '@angular/cdk/table', '@angular/cdk/overlay', '@angular/cdk/portal'], factory) :
    (factory((global.ngxSleek = {}),global.ng.core,null,null,null,global.ng.common,null,null,null));
}(this, (function (exports,core,rxjs,operators,collections,common,table,overlay,portal) { 'use strict';
    ...
    var DirectiveService = /** @class */ (function () {
        function DirectiveService() {
            this.totalColumns = new rxjs.BehaviorSubject(0);
    ...
    var SlkHeaderRowDefDirective = /** @class */ (function (_super) {
        ...
        SlkHeaderRowDefDirective.propDecorators = {
            "slkHeaderRowDef": [{ type: core.Input, args: ['slkHeaderRowDef',] },],
    ...
    var SlkRowDefDirective = /** @class */ (function (_super) {
        ...
        SlkRowDefDirective.propDecorators = {
            "slkRowDefColumns": [{ type: core.Input, args: ['slkRowDefColumns',] },],
            "columns": [{ type: core.Input },],
        };
    ...
    var SlkCellOutletDirective = /** @class */ (function () {
        ...
        SlkCellOutletDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[slkCellOutlet]' },] },
        ];
        /** @nocollapse */
    ...
    var SlkCellDefDirective = /** @class */ (function () {
        ...
        SlkCellDefDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[slkCellDef]' },] },
        ];
        /** @nocollapse */
    ...
    var SlkHeaderCellDefDirective = /** @class */ (function () {
        ...
        SlkHeaderCellDefDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[slkHeaderCellDef]' },] },
        ];
        /** @nocollapse */
    ...
    var SlkFooterCellDefDirective = /** @class */ (function () {
        ...
        SlkFooterCellDefDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[slkFooterCellDef]' },] },
        ];
        /** @nocollapse */
    ...
    var SlkColumnDefDirective = /** @class */ (function (_super) {
        ...
        SlkColumnDefDirective.propDecorators = {
            "name": [{ type: core.Input, args: ['slkColumnDef',] },],
            "cell": [{ type: core.ContentChild, args: [SlkCellDefDirective,] },],
            "headerCell": [{ type: core.ContentChild, args: [SlkHeaderCellDefDirective,] },],
            "footerCell": [{ type: core.ContentChild, args: [SlkFooterCellDefDirective,] },],
        };
    ...
    var SlkTableComponent = /** @class */ (function () {
        ...
        SlkTableComponent.propDecorators = {
            "scrollToBottom": [{ type: core.Output, args: ['scrollToBottom',] },],
            "length": [{ type: core.Input },],
            "trackBy": [{ type: core.Input },],
            "dataSource": [{ type: core.Input },],
            "_rowOutlet": [{ type: core.ViewChild, args: [DataRowOutletDirective,] },],
            "_headerRowOutlet": [{ type: core.ViewChild, args: [HeaderRowOutletDirective,] },],
            "_footerRowOutlet": [{ type: core.ViewChild, args: [FooterRowOutletDirective,] },],
            "_contentColumnDefs": [{ type: core.ContentChildren, args: [SlkColumnDefDirective,] },],
            "_contentRowDefs": [{ type: core.ContentChildren, args: [SlkRowDefDirective,] },],
            "_contentHeaderRowDefs": [{ type: core.ContentChildren, args: [SlkHeaderRowDefDirective,] },],
            "_contentFooterRowDefs": [{ type: core.ContentChildren, args: [SlkFooterRowDefDirective,] },],
    ...
    SlkGridDataSource = /** @class */ (function (_super) {
        ...
        function () {
            ...
            var /** @type {?} */ sortChange = this._sort ?
                rxjs.merge(this._sort.slkSortChange, this._sort.initialised) :
                rxjs.of(null);
            var /** @type {?} */ pageChange = this._paginator ?
                rxjs.merge(this._paginator.page, this._paginator.initialised) :
                rxjs.of(null);
            var /** @type {?} */ filterChange = this._filter ?
                rxjs.merge(this._filter.slkFilterChange, this._filter.initialised) :
                rxjs.of(null);
            var /** @type {?} */ dataStream = this._data;
            // Watch for sort changes to provide ordered data
            var /** @type {?} */ orderedData = rxjs.combineLatest(dataStream, sortChange)
            ...
            var /** @type {?} */ filteredData = rxjs.combineLatest(paginatedData, filterChange)
                .pipe(operators.map(function (_a) {
                var data = _a[0];
    ...
    var SlkSortDirective = /** @class */ (function () {
        function SlkSortDirective(sortDirService) {
             ...
             */
            this.initialised = new rxjs.BehaviorSubject(false);
            /**
             ...
             */
            this.slkSortChange = new core.EventEmitter();
        }
        ...
        SlkSortDirective.propDecorators = {
            "active": [{ type: core.Input, args: ['slkSortActive',] },],
            "start": [{ type: core.Input, args: ['slkSortStart',] },],
            "direction": [{ type: core.Input, args: ['slkSortDirection',] },],
            "slkSortChange": [{ type: core.Output, args: ['slkSortChange',] },],
        };
    ...
    var SlkSortHeaderComponent = /** @class */ (function () {
        ...
        SlkSortHeaderComponent.ctorParameters = function () { return [
            { type: SlkSortDirective, decorators: [{ type: core.Optional },] },
            { type: SlkColumnDefDirective, decorators: [{ type: core.Optional },] },
            { type: core.Renderer2, },
            { type: SortDirectiveService, },
        ]; };
        SlkSortHeaderComponent.propDecorators = {
            "id": [{ type: core.Input, args: ['slk-sort-header',] },],
            "start": [{ type: core.Input },],
            "sortBtn": [{ type: core.ViewChild, args: ['sortBtn',] },],
        };
    ...
    var SlkTreeTextOutletDirective = /** @class */ (function () {
        ...
        SlkTreeTextOutletDirective.decorators = [
            { type: core.Directive, args: [{ selector: '[slkTreeTextOutlet]' },] },
        ];
        /** @nocollapse */
    ...
    var SlkTreeComponent = /** @class */ (function () {
        function SlkTreeComponent(_differs, _changeDetectorRef) {
             ...
             */
            this.reorderData = new core.EventEmitter();
            /**
        ...
        SlkTreeComponent.propDecorators = {
            ...
            "trackBy": [{ type: core.Input },],
            "reorderData": [{ type: core.Output, args: ['reorderData',] },],
            "_nodeOutlet": [{ type: core.ViewChild, args: [SlkTreeNodeOutletDirective,] },],
            "_nodeDefs": [{ type: core.ContentChildren, args: [SlkTreeNodeDefDirective,] },],
        };
    ...
    var ActionsService = /** @class */ (function () {
        function ActionsService() {
            ...
            this.addAction = new rxjs.BehaviorSubject(false);
        ...
        function (key, fallback, maxAge) {
            if (this.hasValidCachedValue(key)) {
                return rxjs.of(this.cache.get(key).data);
            }
            if (!maxAge) {
            ...
            if (this.inFlightObseravbles.has(key)) {
                ...
                return rxjs.Observable.throw('Requested key is not available in the Cache');
            }
        };
        /**
         * @param {?} key
    ...
    var SlkNestedTreeNodeDirective = /** @class */ (function (_super) {
        ...
        SlkNestedTreeNodeDirective.ctorParameters = function () { return [
            ...
            { type: core.ViewContainerRef, },
            { type: core.Renderer2, },
            { type: ActionsService, decorators: [{ type: core.Optional },] },
        ]; };
        SlkNestedTreeNodeDirective.propDecorators = {
            "nodeOutlet": [{ type: core.ContentChildren, args: [SlkTreeNodeOutletDirective,] },],
    ...
    var SlkAddActionDirective = /** @class */ (function () {
        ...
        SlkAddActionDirective.propDecorators = {
            "appContentAction": [{ type: core.Input },],
            "appContentActionElse": [{ type: core.Input },],
        };
    ...
    var SlkPaginatorChildComponent = /** @class */ (function () {
        ...
        SlkPaginatorChildComponent.propDecorators = {
            ...
            "nav": [{ type: core.ViewChild, args: [SlkNavDirective,] },],
            "pageBtnTemplate": [{ type: core.ContentChild, args: [SlkPageIndexDirective, { read: core.TemplateRef },] },],
        };
    ...
    var SlkGridFilterDirective = /** @class */ (function () {
        function SlkGridFilterDirective() {
             ...
             */
            this.slkFilterChange = new core.EventEmitter();
        }
        /**
        ...
        SlkGridFilterDirective.propDecorators = {
            "active": [{ type: core.Input, args: ['slkFilterActive',] },],
            "slkFilterChange": [{ type: core.Output, args: ['slkFilterChange',] },],
        };
    ...
    var SlkGridPopupComponent = /** @class */ (function () {
        ...
        SlkGridPopupComponent.ctorParameters = function () { return [
            { type: Array, decorators: [{ type: core.Inject, args: [OPTIONS_DIALOG_DATA,] },] },
            { type: ActionsService, },
        ]; };
     ...
     * @suppress {checkTypes} checked by tsc
     */
    var /** @type {?} */ OPTIONS_DIALOG_DATA = new core.InjectionToken('OPTIONS_DIALOG_DATA');
    ...
    var DomService = /** @class */ (function () {
        function DomService(injector, overlay$$1) {
            this.injector = injector;
            this.overlay = overlay$$1;
            this.onClose = new rxjs.BehaviorSubject(false);
        ...
        function (overlayRef, config, dialogRef) {
            ...
            var /** @type {?} */ containerPortal = new portal.ComponentPortal(SlkGridPopupComponent, null, injector);
        ...
        function (elementRef) {
            ...
            return this.overlay.position()
                .connectedTo(elementRef, origin.bottomLeft, overlay$$1.topLeft)
                .withOffsetY(10)
                .withDirection('rtl')
                .withFallbackPosition(origin.bottomRight, overlay$$1.topRight)
                .withFallbackPosition(origin.topLeft, overlay$$1.bottomLeft)
                .withFallbackPosition(origin.topRight, overlay$$1.bottomRight)
                .withFallbackPosition(origin.topCenter, overlay$$1.bottomCenter)
                .withFallbackPosition(origin.bottomCenter, overlay$$1.topCenter);
        };
    ...
    var SlkGridFilterComponent = /** @class */ (function () {
        ...
        SlkGridFilterComponent.ctorParameters = function () { return [
            { type: SlkGridFilterDirective, decorators: [{ type: core.Optional },] },
            { type: SlkColumnDefDirective, decorators: [{ type: core.Optional },] },
            { type: core.ViewContainerRef, },
            { type: core.ElementRef, },
            { type: DomService, },
        ...
        SlkGridFilterComponent.propDecorators = {
            ...
            "id": [{ type: core.Input, args: ['slk-filter-header',] },],
            "onFilterChange": [{ type: core.HostListener, args: ['click',] },],
        };
    ...
    exports.DataRowOutletDirective = DataRowOutletDirective;
    exports.HeaderRowOutletDirective = HeaderRowOutletDirective;
    exports.FooterRowOutletDirective = FooterRowOutletDirective;
    exports.SLK_TABLE_TEMPLATE = SLK_TABLE_TEMPLATE;
    exports.SlkTableComponent = SlkTableComponent;
    exports.SLK_ROW_TEMPLATE = SLK_ROW_TEMPLATE;
    exports.BaseRowDef = BaseRowDef;
    exports.SlkHeaderRowDefBase = SlkHeaderRowDefBase;
    exports.SlkHeaderRowDefDirective = SlkHeaderRowDefDirective;
    exports.SlkFooterRowDefBase = SlkFooterRowDefBase;
    exports.SlkFooterRowDefDirective = SlkFooterRowDefDirective;
    exports.SlkRowDefDirective = SlkRowDefDirective;
    exports.SlkCellOutletDirective = SlkCellOutletDirective;
    exports.SlkHeaderRowComponent = SlkHeaderRowComponent;
    exports.SlkFooterRowComponent = SlkFooterRowComponent;
    exports.SlkRowComponent = SlkRowComponent;
    exports.SlkCellDefDirective = SlkCellDefDirective;
    exports.SlkHeaderCellDefDirective = SlkHeaderCellDefDirective;
    exports.SlkFooterCellDefDirective = SlkFooterCellDefDirective;
    exports.SlkColumnDefBase = SlkColumnDefBase;
    exports.SlkColumnDefDirective = SlkColumnDefDirective;
    exports.BaseSlkCell = BaseSlkCell;
    exports.SlkHeaderCellDirective = SlkHeaderCellDirective;
    exports.SlkFooterCellDirective = SlkFooterCellDirective;
    exports.SlkCellDirective = SlkCellDirective;
    exports.SlkGridModule = SlkGridModule;
    exports.SlkGridDataSource = SlkGridDataSource;
    exports.DirectiveService = DirectiveService;
    exports.SlkSortModule = SlkSortModule;
    exports.SlkSortHeaderComponent = SlkSortHeaderComponent;
    exports.SlkSortDirective = SlkSortDirective;
    exports.SlkTreeComponent = SlkTreeComponent;
    exports.SlkTreeModule = SlkTreeModule;
    exports.SlkNestedTreeNodeDirective = SlkNestedTreeNodeDirective;
    exports.NestedTreeControl = NestedTreeControl;
    exports.SlkTreeNodeOutletDirective = SlkTreeNodeOutletDirective;
    exports.SlkTreeNodeOutletContext = SlkTreeNodeOutletContext;
    exports.SlkTreeNodeDefDirective = SlkTreeNodeDefDirective;
    exports.SlkTreeNodeDirective = SlkTreeNodeDirective;
    exports.SlkTreeTextOutletDirective = SlkTreeTextOutletDirective;
    exports.SlkTreeActionDirective = SlkTreeActionDirective;
    exports.SlkContentActionContext = SlkContentActionContext;
    exports.SlkTreeNodeTextComponent = SlkTreeNodeTextComponent;
    exports.SlkAddActionDirective = SlkAddActionDirective;
    exports.viewRefKey = viewRefKey;
    exports.viewRefContainer = viewRefContainer;
    exports.dataNode = dataNode;
    exports.ActionsService = ActionsService;
    exports.SlkNavDirective = SlkNavDirective;
    exports.SlkPageIndexDirective = SlkPageIndexDirective;
    exports.PAGINATOR_CHILD_TEMPLATE = PAGINATOR_CHILD_TEMPLATE;
    exports.PageEvent = PageEvent;
    exports.PaginatorContext = PaginatorContext;
    exports.viewContainerRef = viewContainerRef;
    exports.SlkPaginatorChildComponent = SlkPaginatorChildComponent;
    exports.SlkPaginatorComponent = SlkPaginatorComponent;
    exports.SlkPaginatorModule = SlkPaginatorModule;
    exports.SlkGridFilterDirective = SlkGridFilterDirective;
    exports.actualData = actualData;
    exports.FILTER_PANEL_MAX_HEIGHT = FILTER_PANEL_MAX_HEIGHT;
    exports.FILTER_PANEL_VIEWPORT_PADDING = FILTER_PANEL_VIEWPORT_PADDING;
    exports.SlkGridFilterComponent = SlkGridFilterComponent;
    exports.SlkGridFilterRef = SlkGridFilterRef;
    exports.DomService = DomService;
    exports.OPTIONS_DIALOG_DATA = OPTIONS_DIALOG_DATA;
    exports.SlkFilterModule = SlkFilterModule;
    exports.selectedOptions = selectedOptions;
    exports.SlkGridPopupComponent = SlkGridPopupComponent;
    exports.SlkGridPopupModule = SlkGridPopupModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-sleek.umd.js.map
